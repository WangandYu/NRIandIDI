...
for(m in 1:nsim)
{
  ...
  for(t0 in T0){
    ...
    write.table(t(c(n1,n2,n3)),paste("IDI_n_",t0,"_",name,".txt",sep=""), sep="\t", row.names = FALSE,col.names = FALSE,append = TRUE)
  }
  #############################################################################
  ...
  for(i in 1:3){
    ...
    write.table(t(c(sum1,sum2,sum3)),paste("IDI_sum_",T0[i],"_",name,".txt",sep=""), sep="\t", row.names = FALSE,col.names = FALSE,append = TRUE)
  }
}

dir2=''
ns = read.table(paste(dir2,"IDI_n_11.txt",sep=""),header = FALSE)
dim(ns)
ns = apply(ns,2,sum)
totaln = sum(ns)

sums = read.table(paste(dir2,"IDI_sum_11.txt",sep=""),header = FALSE)
dim(sums)
sums = apply(sums,2,sum)

sum(sums/ns/(1-ns/totaln))/3

ns = read.table(paste(dir2,"IDI_n_12.txt",sep=""),header = FALSE)
dim(ns)
ns = apply(ns,2,sum)
totaln = sum(ns)

sums = read.table(paste(dir2,"IDI_sum_12.txt",sep=""),header = FALSE)
dim(sums)
sums = apply(sums,2,sum)

sum(sums/ns/(1-ns/totaln))/3

ns = read.table(paste(dir2,"IDI_n_13.txt",sep=""),header = FALSE)
dim(ns)
ns = apply(ns,2,sum)
totaln = sum(ns)

sums = read.table(paste(dir2,"IDI_sum_13.txt",sep=""),header = FALSE)
dim(sums)
sums = apply(sums,2,sum)
